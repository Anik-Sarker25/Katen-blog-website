	...
	<header class="header-default">
		<nav class="navbar navbar-expand-lg">
			<div class="container-xl">
                {{-- site logo --}}
                @if(isset($site->logo))
                    <a href="{{ route('home')}}" class="d-block text-logo"><img src="{{ asset('uploads/sitelogo') }}/{{ $site->logo }}" alt=""></a>
                @else
                    <a href="{{ route('home')}}" class="d-block text-logo"><img src="{{ asset('frontend_assets') }}/images/logo.svg" alt=""></a>
                @endif

...
<!-- Mirrored from themeger.shop/html/katen/html/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Nov 2023 05:32:51 GMT -->
<head>
		...
		<div class="container-xl">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('category.post', $single_post->reletionwithcategory->id )}}">{{$single_post->reletionwithcategory->title}}</a></li>
			...
			<div class="row gy-4">
                ...
                {{-- footer and sidebar start form here --}}
...
<!-- Mirrored from themeger.shop/html/katen/html/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Nov 2023 05:32:53 GMT -->
</html>

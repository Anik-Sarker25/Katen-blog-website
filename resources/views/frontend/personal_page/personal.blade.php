    ...
    <section class="hero data-bg-image d-flex align-items-center" data-bg-image="{{ asset('frontend_assets') }}/images/other/hero.jpg">
        <div class="container-xl">
            ...
            <div class="cta text-center">
                <h2 class="mt-0 mb-4">I'm @if(isset($post)){{ $post->reletionwithuser->name }}@else your name goes here @endif</h2>
                <p class="mt-0 mb-4">@if(isset($post)){{ $post->reletionwithuser->about }}@else your description goes here @endif</p>
                <a href="{{route('about')}}" class="btn btn-light mt-2">About Me</a>
            </div>
        </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-8">
                    <div class="row gy-4">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="post post-grid rounded bordered">
                                    <div class="thumb top-rounded">
                                        <a href="{{ route('category.post', $post->reletionwithcategory->id )}}" class="category-badge position-absolute">{{ $post->reletionwithcategory->title }}</a>
                        ...
                        @empty
                        <p class="text-center text-danger">SORRY, POST NOT FOUND!</p>
                        @endforelse
